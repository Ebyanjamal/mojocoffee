...
function Menu() {
  return (
    ...
    className=' flex relative px-0 md:px-10 p-4 col-span-3 shadow-xl shadow-white-100 rounded-xl lg:p-4 ml-4 pl-10 w-64 border'>
        <ul>
    ...
    whileHover={{ scale: 1.1 }}
    transition={{ type: "spring", stiffness: 400, damping: 10}}  
    className='overflow:hidden flex relative px-0 md:px-10 p-4 col-span-3 shadow-xl shadow-white-100 rounded-xl lg:p-4 ml-4 border'>
        <ul>
